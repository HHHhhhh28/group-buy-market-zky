...
package com.zky.domain.trade.service.settlement.factory;
...
import com.zky.domain.trade.service.settlement.filter.EndRuleFilter;
import com.zky.domain.trade.service.settlement.filter.OutTradeNoRuleFilter;
import com.zky.domain.trade.service.settlement.filter.SCRuleFilter;
import com.zky.domain.trade.service.settlement.filter.SettableRuleFilter;
...
public class TradeSettlementRuleFilterFactory {
    ...
    public BusinessLinkedList<TradeSettlementRuleCommandEntity, TradeSettlementRuleFilterFactory.DynamicContext, TradeSettlementRuleFilterBackEntity> tradeSettlementRuleFilter(
        ...
        LinkArmory<TradeSettlementRuleCommandEntity, TradeSettlementRuleFilterFactory.DynamicContext, TradeSettlementRuleFilterBackEntity> linkArmory =
                new LinkArmory<>("交易规则过滤链", scRuleFilter, outTradeNoRuleFilter, settableRuleFilter, endRuleFilter);
