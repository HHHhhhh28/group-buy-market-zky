...
import com.zky.domain.activity.service.discount.IDiscountCalculateService;
...
import com.zky.domain.activity.service.trial.thread.QueryGroupBuyActivityDiscountVOThreadTask;
import com.zky.domain.activity.service.trial.thread.QuerySkuVOFromDBThreadTask;
...
public class MarketNode   extends AbstractGroupBuyMarketSupport<MarketProductEntity, DefaultActivityStrategyFactory.DynamicContext, TrialBalanceEntity> {
    ...
    public TrialBalanceEntity doApply(MarketProductEntity requestParameter, DefaultActivityStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        if(skuVO == null || groupBuyDiscount == null) {
            return router(requestParameter, dynamicContext);
        }
    ...
    public StrategyHandler<MarketProductEntity, DefaultActivityStrategyFactory.DynamicContext, TrialBalanceEntity> get(MarketProductEntity requestParameter, DefaultActivityStrategyFactory.DynamicContext dynamicContext) throws Exception {
        if(dynamicContext.getDeductionPrice() == null
                || dynamicContext.getSkuVO() == null
                || dynamicContext.getGroupBuyActivityDiscountVO() == null){
            return errorNode;
        }
